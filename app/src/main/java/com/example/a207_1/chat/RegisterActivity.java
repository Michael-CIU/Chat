...
import com.example.a207_1.chat.MainActivity;
import com.example.a207_1.chat.R;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    com.example.lenovo.mychats.User user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_regis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                user = new com.example.lenovo.mychats.User();
