package com.example.a207_1.chat;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user==null){
            Intent intent= new Intent(MainActivity.this, com.example.a207_1.chat.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.menuUser:
                Intent intent = new Intent(MainActivity.this, com.example.lenovo.mychats.UserListActivity.class);
                startActivity(intent);
                return true;
